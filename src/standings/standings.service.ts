...
import { StandingsDTO } from 'src/dto/standing.dto';
...
export class StandingsService {
  ...
  private getApiData(
    id: string,
  ): Observable<AxiosResponse<{ response: { league: StandingsDTO }[] }>> {
  ...
  async getStandingsById(id: string) {
    const { data } = await firstValueFrom(this.getApiData(id));
    const { response } = data;
